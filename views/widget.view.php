...
$container = (new CDiv())
    ...
    ->setAttribute('data-color-scale-mode', (string) ($data['color_scale_mode'] ?? 0))
    ->setAttribute('data-color-scale-low', (string) ($data['color_scale_low'] ?? 3))
    ->setAttribute('data-color-scale-high', (string) ($data['color_scale_high'] ?? 10))
